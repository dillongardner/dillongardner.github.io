...
stlDaily <- stlplus(jfkManhattan$Total,t=jfkManhattan$Date,
                    n.p=7, s.window=5,
                    sub.labels=weekDays, sub.start=1)
plot_seasonal(stlDaily, main="Seasonal Window: 5")
```
...
stlDaily <- stlplus(jfkManhattan$Total,t=jfkManhattan$Date,
                    n.p=7, s.window=25,
                    sub.labels=weekDays, sub.start=1)
plot_seasonal(stlDaily, main="Seasonal Window: 25")
```
...
stlDaily <- stlplus(jfkManhattan$Total,t=jfkManhattan$Date,
                    n.p=7, s.window=500,
                    sub.labels=weekDays, sub.start=1)
plot_seasonal(stlDaily, main="Seasonal Window: 500")
```
...
stlDaily <- stlplus(jfkManhattan$Total,t=jfkManhattan$Date,
                    ...
                    sub.labels=weekDays, sub.start=1)
plot_seasonal(stlDaily, main="Seasonal Window: periodic")
```
